package com.gmail.vanyadubik.mobilemanager.gps;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public LocationPoint getLocationPoint(){
        getLocation();
        if(location != null){
            return new LocationPoint(LocalDate.now().toDate(), location.getLatitude(),
                    location.getLongitude(), true);
        }
        return new LocationPoint(LocalDate.now().toDate(), latitude, longitude, true);
    }
