...
import com.gmail.vanyadubik.mobilemanager.app.MobileManagerAplication;
import com.gmail.vanyadubik.mobilemanager.repository.DataRepository;
import com.gmail.vanyadubik.mobilemanager.service.SyncService;
...
public class SyncIntentService extends IntentService{
    ...
    public void onCreate() {
        super.onCreate();
        ((MobileManagerAplication) getApplication()).getComponent().inject(this);
    }
