...
//        }
    ...
    public Location FilteredLocation(Location currentlocation, Location newLocation)  {

        KalmanFilterLocation kalmanFilterLocation = new KalmanFilterLocation();

        return kalmanFilterLocation.FilteredLocation(currentlocation, newLocation);
